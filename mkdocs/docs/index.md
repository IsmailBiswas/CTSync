...
CTSync is a cross-platform application that seamlessly syncs clipboard text
across multiple devices. Whether you're working on Linux, Windows, or macOS,
CTSync ensures your clipboard is always up to date, simplifying copying and
pasting between devices without interruption. It partially works on Android, as
Android 10 and later versions restrict background clipboard monitoring.
...
Below is a quick guide to get started.
